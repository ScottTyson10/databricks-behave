...
from databricks_utils import for_each_table, get_table_extended_properties_json
...
def step_check_all_tables_managed_or_comment(context, catalog_schema):
    def check(_, catalog, schema, table):
        props = get_table_extended_properties_json(context.dbx, catalog, schema, table)
